...
const Page: NextPage<Props> = async ({ params }) => {
  ...
  return (
    <article className="container prose prose-lg prose-neutral max-w-screen-lg py-4 dark:prose-invert prose-code:font-mono">
...
export const generateMetadata = async ({ params }: Props, parent: ResolvingMetadata) => {
  ...
  return seo({
    ...
    images: [post.mainImage.src, ...previousImages],
  })
}
